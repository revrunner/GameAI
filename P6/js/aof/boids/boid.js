	...
	preUpdate : function(t, neighbors) {
		...
		*/
		...
		if(this.flock.dna.values[16] > .5){
			...
			this.forces[6].setToDifference(this, app.mouse);
			this.forces[6].mult(-2);
		...
		this.forces[7].setTo(this.v);
		this.forces[7].normalize();
		this.forces[7].mult(this.flock.dna.values[18]*(-100));
